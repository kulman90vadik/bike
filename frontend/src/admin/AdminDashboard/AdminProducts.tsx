import { ChevronDown, PencilLine, Plus, Trash2, X } from "lucide-react"
...
const AdminProducts = () => {
    ...
    return (
        <div className={styles.list}>
            ...
            <article className={`${styles.products} ${styles.addproduct}`}>
                <button type="button">
                    <Plus />
                </button>
            </article>
                ...
                <article key={product._id} className={styles.products}>
                    ...
                    <div className={styles.info}>
                        ...
                        <div className={styles.block}>
                            ...
                            {Math.round(Number(product.price) * (1 - Number(product.sale?.replace(/%/g, "")) / 100))}
                        </div>
                        <div className={styles.block}>
