...
import { routeHandler } from "../../redux/slices/admin"
...
const navigation = [
    { route: "adminProducts", name: "Products" },
    { route: "adminUsers", name: "Users" }
]
        ...
        <header className={styles.header}>
            {/* <Link to="/"> */}
                <svg className={styles.logo} viewBox="0 0 87 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    />
                    <path
                        d="M65.6308 40.2972L67.3106 35.8307L63.5 33.0465H68.3736L69.9314 28.6216L71.2016 33.127H75.8704L71.9379 35.7503L73.1277 40.2972L69.6852 37.7153"
                        fill="#F57520"
                    />
                ...
                {navigation.map((item, index) => {
                    ...
                    return (
                        <div
                            ...
                            onClick={() => {
                                setActiveIndex(index), clickLink(item.route)
                            }}
                        >
                            <button className={`${styles.btn} ${isActive ? styles.active : ""}`} type="button">
                                {item.name}
                            </button>
                        </div>
                    )
            ...
            <img className={styles.decor} src="/images/bgg.png" alt="Decor" />
        </header>
    )
}
