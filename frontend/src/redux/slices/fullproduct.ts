...
export const fetchProduct = createAsyncThunk<ProductProps, string, { state: RootState }>(
  'auth/fetchProduct',
  async (productId ) => {
...
export const fetchDelProductComment = createAsyncThunk<ProductProps, DeleteReviewPayload, { state: RootState }>(
  'auth/fetchDelProductComment',
...
export const fetchProductComment = createAsyncThunk<ProductProps, reviewPayload, { state: RootState }>(
  'auth/fetchProductComment',
  async ({ id, values, rating }) => {
